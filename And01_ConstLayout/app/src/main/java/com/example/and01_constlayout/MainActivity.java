...
public class MainActivity extends AppCompatActivity {
    ...
    //ImageView imgv_jep; // 전역 변수 선언 초기상태 null
    @Override
...
//        imgv_jep = findViewById(R.id.imgv_jep);//@IdRes== R클래스에서 내용을 찾아서 넣어주세요.  ctrl + p
//
//        // 인터페이스 옵저버 패턴
//        imgv_jep.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//        JepOnClickListener onClickListener = new JepOnClickListener() {
//            @Override
//            public void onClick(String data) {
//                Toast.makeText(MainActivity.this, "메소드 실행되었습니다.JEP", Toast.LENGTH_SHORT).show();
//            }
//        };
//        // 메소드는 언제 실행되는가? 메소드는 호출되어야만 실행이 된다.
//        onClickListener.onClick("데이터");

//        setOnclickListener(new JepOnClickListener() {
//            @Override
//            public void onClick(String data) {
//
//            }
...
//    public void setOnclickListener(JepOnClickListener onClickListener){
//
//    }

//    public interface  JepOnClickListener {
//        public void onClick(String data);
//    }
