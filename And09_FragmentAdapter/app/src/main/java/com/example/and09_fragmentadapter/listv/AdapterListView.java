...
import com.example.and09_fragmentadapter.ListDTO;
import com.example.and09_fragmentadapter.R;

import java.util.ArrayList;

//class 상속 : BaseAdapter라는 Class 상속( extends BaseAdapter)
public class AdapterListView extends BaseAdapter {
    ...
    //아이템을 유일하게 식별할 수 있는 값인데 position 자체가 유일하기 때문에 return부를 바꿔준다.
    @Override
    public long getItemId(int position) {
        return position;
    }

    //LayoutInflater를 이용해서 칸마다의 아이템을 붙이는 처리르 해줘야함.
    @Override
